...
-->			</div>
		...
		<div class="body">
			...
			<span>Here you can see the prices of goods changes occure time by time showing in Graphs.</span>
			<div>
				<a href="index.php"><img src="images/charts-graphs-sales-16917486_01.jpg" alt="Image" class="ab11"/></a>
				<div style="margin-left:20px;margin-top:20px;float:left;">
				<fieldset style="height:auto" class="abc21">
	
						<legend ><b>Fruits</b></legend>
	...
	<tr>
		...
		<td style="padding-top:7px;text-decoration:none"><a style="text-decoration:none;margin-left:40px;color:#006" href="graph_select.php?fid=<?php echo $objRow->fid;?>"><?php echo $objRow-> name;?></a></td>
	</tr>
	<?php } ?>
			</table>			
					</fieldset>
				...
				<fieldset style="height:auto" class="abc21">
						...
						<legend ><b>Vegetables</b></legend>
	<table cellpadding="0" cellspacing="0" border="0" >
		<?php
		$Index = 0;
		$Query1 = "SELECT * FROM vegetables ";
	...
	<tr>
		...
		<td style="padding-top:7px;text-decoration:none"><a style="text-decoration:none;margin-left:50px;color:#006" href="graph_select_veg.php?vid=<?php echo $objRow1->vid;?>"><?php echo $objRow1-> name;?></a></td>
	</tr>
	<?php } ?>
			</table>			
					</fieldset>
