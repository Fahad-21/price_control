...
-->					<fieldset style="height:auto">
							<legend >Fruits</legend>
							 <table cellpadding="0" cellspacing="0" border="1" width="616px"  >
...
-->		<td><strong>Name</strong></td>
	...
	//echo $_REQUEST['date'];
		$index=0;
		$Query = "SELECT main.price,fruits.name,fruits.unitt FROM `main`  INNER JOIN fruits ON main.fid= fruits.fid  WHERE date ='".$_REQUEST['date']."' AND cid ='".$_REQUEST['cid']."' ";
		//echo $Query; die();
	...
	//echo $_REQUEST['date'];
	$Index = 0;
		$Query5 = "SELECT * FROM main1  WHERE cid = '1' AND vid = '1' " ;
		//echo $Query; die();
