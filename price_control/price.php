...
-->			</div>
	...
	<tr>
		...
		<td style="padding-top:7px;float:left;text-decoration:none"><a style="text-decoration:none;margin-left:100px;color:#039" href="date.php?cid=<?php echo $objRow->cid;?>"><?php echo $objRow-> name;?></a></td>
	</tr>
	<?php } ?>
			</table>			
					</fieldset>
