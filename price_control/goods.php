	...
	if(isset($_REQUEST['Search'])){
	   ...
	   // echo $Query0; die;
		...
		if($rows0 >=1){
			...
			header("location: goods.php?error");
		}
	}
...
-->			</div>
				...
				<form name="contact" method="post" action="">
						...
						?>
							<tr >
								...
								<td><input type="submit" name="Search" value="Search" class="button1"/></td>
								</tr>
					...
					<span><marquee scrollamount="4px" behavior="alternate" direction="right">Select a catageory to view the Goods</marquee></span>
					<fieldset style="height:auto" class="ab">
	
						<legend >Selecting Goods</legend>
	<a href="fruit.php" style="margin-left:110px;font-size:22px;color:#039;text-decoration:none;font-family:Jokerman;float:left" >Fruits</a>
	      <span style="float:left;margin-left:30px;margin-top:6px;font-size:22px"> &amp; </span>
	<a href="vegetable.php" style="margin-left:50px;font-size:22px;color:#039;text-decoration:none;font-family:Jokerman;float:left" >Vegetables</a>
					</fieldset>
					
					<span><marquee scrollamount="4px" behavior="alternate" direction="right">Select a City to view list of goods</marquee></span>
					<fieldset style="height:auto" class="ab">
	...
	<tr>
		...
		<td style="padding-top:7px"><a style="text-decoration:none;margin-left:110px;font-size:14px;font-weight:bold;color:#036" href="date1.php?cid=<?php echo $objRow->cid;?>"><?php echo $objRow-> name;?></a></td>
	</tr>
	<?php } ?>
			</table>			
					</fieldset>
