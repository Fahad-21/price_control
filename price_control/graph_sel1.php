...
-->			</div>
	...
	<tr>
		...
		<td style="padding-top:7px;text-decoration:none"><a style="text-decoration:none;margin-left:40px;color:#006" href="graph_fruit.php?fid=<?php echo $objRow->fid;?>"><?php echo $objRow-> name;?></a></td>
	</tr>
	<?php } ?>
			</table>			
					</fieldset>
	...
	<tr>
		...
		<td style="padding-top:7px;text-decoration:none"><a style="text-decoration:none;margin-left:50px;color:#006" href="graph_veg.php?vid=<?php echo $objRow1->vid;?>"><?php echo $objRow1-> name;?></a></td>
	</tr>
	<?php } ?>
			</table>			
					</fieldset>
