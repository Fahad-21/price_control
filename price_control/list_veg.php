...
-->		<td><strong>Name</strong></td>
	...
	//echo $_REQUEST['date'];
		$index=0;
		$Query = "SELECT main1.price,vegetables.name,vegetables.unit FROM `main1`  INNER JOIN vegetables ON main1.vid= vegetables.vid  WHERE date ='".$_REQUEST['date']."' AND cid ='".$_REQUEST['cid']."' ";
