...
-->			</div>
		...
		<div class="body">
								<b> Graph of Fruits with in a city wise</b>

		</div>
		<div style="margin-left:152px;background-color:#f6efe5;font:75% Arial, Helvetica, sans-serif;width:960px;height:1150px;margin-top:-35px">
...
<ul class="yAxis">
	...
	<b>Sahiwal = 1</b>
		<?php
		$Index = 0;
				$Query = "SELECT * FROM `main1`  WHERE vid = '".$_REQUEST['vid']."' AND cid='1' " ;

/*		$Query = "SELECT main.price,city.name FROM `main`  INNER JOIN city ON main.cid= city.cid  WHERE fid = '".$_REQUEST['fid']."'  " ;
*/		//echo $Query;die;
	...
	?>
		<dd class="p<?php echo $objRow-> price; ?>"><span><b><?php echo $objRow-> price; ?><br /><?php echo $objRow-> cid; ?></b></span></dd>
	<?php } ?>			
</dl>
<ul class="xAxis">
	<?php
...
<ul class="yAxis">
	...
	<b>Faisalabad = 2</b>
		<?php
		$Index = 0;
				$Query = "SELECT * FROM `main1`  WHERE vid = '".$_REQUEST['vid']."' AND cid='2' " ;
...
<ul class="yAxis">
	...
	<b>Lahore = 3</b>
		<?php
		$Index = 0;
				$Query = "SELECT * FROM `main1`  WHERE vid = '".$_REQUEST['vid']."' AND cid='3' " ;
