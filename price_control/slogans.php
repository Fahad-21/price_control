...
-->			</div>
			<ul>
				...
				<li class="current"><a href="slogans.php"><span>Shout Slogans</span></a></li>
				<li><a href="about.php"><span>About</span></a></li>
				<li><a href="contact.php"><span>Contact</span></a></li>
			</ul>
		</div>
		<div class="body" style="height:610px;">
						<a href="slogans.php"><img src="images/Untitled_02.jpg " alt="Image"  class="ab11"/></a>

<!--			<h2>Shout Slogans</h2>
-->			<span class="abc14">Fruits and Vegetables are an important part of a healthy balanced diet. Here are Fruits and Vegetables slogans and sayings..</span>
				<div>
				<a href="slogans.php"><img src="images/fruits-vegetables-slogans-280x280.jpg" alt="Image" class="abc1"/></a>
				<div style="margin-left:30px;margin-top:30px;float:left">
				<div style="background-color:#FFF;padding:10px 10px;width:150px;height:100px;float:left" class="slogan">Fruits and Vegetables are neat, they make you feel good from your head to your feet.</div>
				<div style="background-color:#FFF;padding:10px 10px;width:150px;height:100px;float:left;margin-left:10px">Junk foods, junk foods go away! Veggies, veggies come on my way!</div>
				<div style="background-color:#FFF;padding:10px 10px;width:150px;height:100px;margin-left:10px;float:left">No need to dispute, Eat veggies and Fruit.</div>
				</div>
				<div style="background-color:#FFF;padding:10px 10px;width:150px;height:100px;margin-left:30px;margin-top:-20px;float:left">Carrots will improve your sight by day and night.</div>
				<div style="background-color:#FFF;padding:10px 10px;width:150px;height:100px;margin-left:10px;margin-top:-20px;float:left">veggies,fruits,and grains eat these everyday ,so that the diseases will be out of your way.</div>
				<div style="background-color:#FFF;padding:10px 10px;width:150px;height:100px;margin-left:10px;margin-top:-20px;float:left">Veggies are a real treat, they make you feel sweet and petite.</div>
				
				<div style="background-color:#FFF;padding:10px 10px;width:262px;height:100px;margin-top:0px;float:left">Fruits and Veggies are good for you body, you'll feel like a super hottie.</div>
				
				<div style="background-color:#FFF;padding:10px 10px;width:150px;height:100px;margin-left:26px;margin-top:0px;float:left">Doctor, Doctor go away, I did eat my veggies today</div>
				<div style="background-color:#FFF;padding:10px 10px;width:150px;height:100px;margin-left:10px;margin-top:0px;float:left">an apple a day, keeps the doctor away.</div>
				<div style="background-color:#FFF;padding:10px 10px;width:150px;height:100px;margin-left:10px;margin-top:0px;float:left">have faith in good food it relaxes us in every mood.</div>
