...
<head>
	...
	<title>Automated Price Controls</title>
...
-->			</div>
		...
		<div id="body">
					<div style="background-color:#006;padding:10px 10px;color:#f2ffff" class="marque"><marquee behavior="scroll" title="Fruits & Vegetables Slogans">
					<?php 
			...
			<ul>
				<li>
					<h1><a href="tips.php">Vegetables</a></h1>
					<div>
						<a href="tips.php"><img src="images/vegetables.jpg" alt="Image" class="abc1"/></a>
					</div>
					
				<span >Health Benefits of Vegetables</span>
				<?php 
			$Query = "SELECT * FROM add_page WHERE name = 'home'";
			$rstRow= mysql_query($Query);
			$objRow =mysql_fetch_object($rstRow);
			?>
     		 <?php echo $objRow->description;?>
					
					<a href="tips.php" class="readmore">Read more</a>
				</li>
				<li>
					<h1><a href="tips.php">Fruits</a></h1>
					<div>
						<a href="tips.php"><img src="images/images.jpg" alt="Image" class="abc1"/></a>
					</div>
					<span>Health Benefits of Fruits</span>
					&nbsp;
					<p>The nutrients in fruit are vital for health and maintenance of your body. The potassium in fruit can reduce your risk of heart disease and stroke. Potassium may also reduce the risk of developing kidney stones and help to decrease bone loss as you age.Their role in preventing vitamin C and vitamin A deficiencies.</p>
					<a href="tips.php" class="readmore">Read more</a>
				</li>
				<li>
					<h1><a href="index.php">Gallery</a></h1>
					<div>
						<a href="index.php"><img src="images/vegetable_plate_with_ham_193738.png" alt="Image" class="abc1"/></a>
					</div>
					<div>
						<a href="index.php"><img src="images/975358.png" alt="Image" class="abc1" /></a>
					</div>
					<a href="tips.php" class="readmore">Read more</a>
				</li>
			</ul>
