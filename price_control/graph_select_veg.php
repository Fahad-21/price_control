...
-->			</div>
		...
		<div class="body">
								<b> All Cities Vegetables List</b>

		</div>
		<div style="margin-left:152px;background-color:#f6efe5;width:960px;height:400px;margin-top:-35px">
	...
	//echo $_REQUEST['date'];
	$Index = 0;
		$Query = "SELECT * FROM main1  WHERE vid = '".$_REQUEST['vid']."' ORDER BY date desc" ;
		//echo $Query; die();
	...
	<tr>
				<td style="padding-top:7px"><a href='graph_view_veg.php?date=<?php echo $objRow-> date;?>&vid=<?php echo $objRow->vid;?>'> <?php echo $objRow->date;?></a></td>
	</tr>
		<?php } ?>
