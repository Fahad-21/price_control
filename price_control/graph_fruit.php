...
-->			</div>
		...
		<div style="margin-left:40px;float:left" class="graph1">	
<ul class="yAxis">
	<li>200</li>
	<li>180</li>
	<li>160</li>
	...
	<dl id="csschart">
		...
		$Index = 0;
				$Query = "SELECT * FROM `main`  WHERE fid = '".$_REQUEST['fid']."' AND cid='1' " ;
...
<ul class="yAxis">
	...
	<b>Faisalabad = 2</b>
		<?php
		$Index = 0;
				$Query = "SELECT * FROM `main`  WHERE fid = '".$_REQUEST['fid']."' AND cid='2' " ;
...
<ul class="yAxis">
	...
	<b>Lahore = 3</b>
		<?php
		$Index = 0;
				$Query = "SELECT * FROM `main`  WHERE fid = '".$_REQUEST['fid']."' AND cid='3'" ;
