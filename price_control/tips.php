...
<head>
	...
	<title>Tips - Automated Price Control</title>
	...
	<link rel="stylesheet" type="text/css" href="css/style.css" />
		<link rel="stylesheet" type="text/css" href="responsive_tips.css" />
...
-->			</div>
			<ul>
				...
				<li class="current"><a href="tips.php"><span>Healthful Tips &amp; Useful Links</span></a></li>
		...
		<div class="body">
			<h2>&nbsp; &nbsp; Healthful Tips &amp; Useful Links</h2>
			<ul>
				<li>
					<a href="index.php" ><img src="images/fruit.jpg" alt="Image"  class="abc1"/></a>
					<?php 
			$Query = "SELECT * FROM add_page WHERE name = 'tips'";
			...
			?>
     		 <?php echo $objRow->description;?>
				...
				<li>
					<a href="index.php"><img src="images/girl-with-fruit-copy.jpg" alt="Image"  class="abc1"/></a>
					<span class="abc">Eating Fruit Provides Health Benefits</span>
					&nbsp;
					<ul class="abc">
						<li>
							<p>Studies show eating apples may help to prevent certain types of cancers. Quercetin, an antioxidant abundant in apples, helps reduce LDL/bad cholesterol oxidation.</p>
						</li>
						<li>
							<p>The high beta-carotene content of apricots makes them an important heart health food.</p>
						</li>
						<li>
							<p>	Bananas are a good source of B vitamins, which may help to remedy sleeplessness, mood swings, and irritability.</p>
						</li>
						<li>
							<p>An excellent source of vitamin C, blackberries have substantial amounts of fiber, iron, calcium, manganese, and potassium. </p>
							</li>
					</ul>
				</li>
			</ul>
