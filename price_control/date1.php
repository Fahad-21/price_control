...
-->			</div>
		...
		<div style="margin-left:152px;width:960px;height:auto;margin-top:-55px" class="idea">
		<div style="margin-left:20px;width:650px;height:auto;" class="idea">	
	<h1 style="color:#006;line-height:10px" class="acc">Price Of Goods</h1>
					<span><marquee scrollamount="4px" behavior="alternate" class="acc"><b>Select Date to view list of goods.</b></marquee></span>
					<div class="ac12">
...
<div>
				<fieldset style="height:auto;" class="ax2" >
	...
	//echo $_REQUEST['date'];
	$Index = 0;
		$Query = "SELECT * FROM main  WHERE cid = '".$_REQUEST['cid']."' AND fid='1' ORDER BY date desc " ;
		//echo $Query; die();
	...
	//echo $_REQUEST['date'];
	$Index = 0;
		$Query = "SELECT * FROM main1  WHERE cid = '".$_REQUEST['cid']."' AND vid='1' ORDER BY date desc " ;
		//echo $Query; die();
		$rstRow = mysql_query($Query);
		//echo $Query; die();
		while($objRow = mysql_fetch_object($rstRow)){
