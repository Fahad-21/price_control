...
-->			</div>
	...
	<tr>
		...
		<td style="padding-top:7px;float:left;text-decoration:none"><a style="text-decoration:none;margin-left:100px;color:#006" href="fruit_list.php?vid=<?php echo $objRow->vid;?>"><?php echo $objRow-> name;?></a></td>
	</tr>
	<?php } ?>
			</table>			
					</fieldset>
...
-->			
	...
	//echo $_REQUEST['date'];
	$Index = 0;
		$Query = "SELECT * FROM main  WHERE cid = '1' AND fid = '1' order by date Desc  Limit 3" ;
		//echo $Query; die();
		$rstRow = mysql_query($Query);
		//echo $Query; die();
		while($objRow = mysql_fetch_object($rstRow)){
	...
	//echo $_REQUEST['date'];
	$Index = 0;
		$Query2 = "SELECT * FROM main  WHERE cid = '2' AND fid = '1' order by date Desc  Limit 3" ;
		//echo $Query; die();
